        ...
        <v-card class="user-settings-card admin-service-card" elevation="0">
          ...
          <v-card-text>
            ...
            <v-row class="mt-2">
              ...
              <v-col cols="12"><div class="structure-zone-heading mt-2"><div class="text-subtitle-2">三、阶段与事件确认</div><div class="text-caption text-medium-emphasis">确认 BOS / CHoCH / 回踩 / 回收是否成立。phase 和 event 由已收盘 K 线动态计算，不在这里手工填写。</div></div></v-col>
