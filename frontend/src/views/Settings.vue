        ...
        <v-card class="user-settings-card admin-service-card" elevation="0">
          ...
          <v-card-text>
            ...
            <v-row class="mt-2">
              ...
              <v-col cols="12"><div class="structure-zone-heading mt-2"><div class="text-subtitle-2">二、市场结构识别 · 箱体与趋势线形态</div><div class="text-caption text-medium-emphasis">箱体、趋势线和形态边界只负责形成结构，不直接生成交易。</div></div></v-col>
              ...
              <v-col cols="12"><div class="structure-zone-heading mt-2"><div class="text-subtitle-2">三、市场结构识别 · 趋势强弱</div><div class="text-caption text-medium-emphasis">判断趋势是健康、成熟、转弱还是失败。</div></div></v-col>
            ...
            <v-row class="mt-2">
              ...
              <v-col cols="12"><div class="structure-zone-heading mt-2"><div class="text-subtitle-2">七、计划生命周期</div><div class="text-caption text-medium-emphasis">结构事件失效、回踩失效和安全兜底共同决定计划何时停止等待。</div></div></v-col>
