      ...
      <v-col cols="12">
        <v-card class="user-settings-card admin-service-card" elevation="0">
          ...
          <v-card-text>
            ...
            <div class="llm-section-head compact mt-4"><div><h3>五、SETUP 专项配置</h3><p>每个 SETUP 在事件成立后，还要满足自己的执行条件。可以只改其中一个 SETUP 的字段，未改字段继续继承上一级。</p></div><div class="d-flex ga-2"><v-btn size="small" variant="tonal" color="secondary" :disabled="structureEngineSaving || !structureSetupScope" @click="openSaveAsStructureSetup">另存为当前范围 SETUP</v-btn></div></div>
