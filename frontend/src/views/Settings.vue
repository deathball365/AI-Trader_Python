        ...
        <v-card class="user-settings-card admin-service-card" elevation="0">
          ...
          <v-card-text>
            ...
            <v-row class="mt-2">
              ...
              <v-col cols="12"><div class="structure-zone-heading mt-2"><div class="text-subtitle-2">二、形态识别 · 箱体 / 三角形 / 趋势线</div><div class="text-caption text-medium-emphasis">每层结构都会识别当前几何形态。这里只形成 pattern，不填写 phase/event，也不直接生成交易。</div></div></v-col>
