      ...
      <v-col cols="12">
        <v-card class="user-settings-card admin-service-card" elevation="0">
          ...
          <v-card-text>
            ...
            <v-row class="mt-2">
              <v-col cols="12"><div class="structure-zone-heading"><div class="text-subtitle-2">一、结构识别 · Internal / Swing / External</div><div class="text-caption text-medium-emphasis">识别三层 Pivot 和结构段。这里只决定看见什么结构，不决定是否下单。</div></div></v-col>
              ...
              <v-col cols="12"><div class="structure-zone-heading mt-2"><div class="text-subtitle-2">二、形态识别</div><div class="text-caption text-medium-emphasis">Internal / Swing / External 各自识别当前几何形态。箱体、三角形、趋势线分开配置；这里只形成 pattern，不填写 phase/event。</div></div></v-col>
              <v-col cols="12"><div class="text-subtitle-2 mt-1">2.1 箱体</div><div class="text-caption text-medium-emphasis">上下沿接近水平、内部反复运行时识别为 range。</div></v-col>
              ...
              <v-col cols="12"><div class="text-subtitle-2 mt-2">2.2 三角形</div><div class="text-caption text-medium-emphasis">上下沿收敛或单边收敛时识别为 triangle。突破是否可交易，在 SETUP 执行层单独配置。</div></v-col>
              ...
              <v-col cols="12"><div class="text-subtitle-2 mt-2">2.3 趋势线</div><div class="text-caption text-medium-emphasis">用高低点拟合支撑/压力线，识别趋势整理或倾斜通道。</div></v-col>
              ...
              <v-col cols="12"><div class="structure-zone-heading mt-2"><div class="text-subtitle-2">三、阶段与事件确认</div><div class="text-caption text-medium-emphasis">phase 和 event 由已收盘 K 线动态计算，这里只配确认阈值。止损距离属于 SETUP 执行，不放在这一层。</div></div></v-col>
              <v-col cols="12"><div class="text-subtitle-2 mt-1">3.1 趋势阶段</div><div class="text-caption text-medium-emphasis">判断当前趋势是推进、成熟还是衰竭。这是 phase，不是下单条件。</div></v-col>
              ...
              <v-col cols="12"><div class="text-subtitle-2 mt-2">3.2 BOS 延续突破</div><div class="text-caption text-medium-emphasis">同向突破确认后，当前结构段继续，不新开一段。</div></v-col>
              ...
              <v-col cols="12"><div class="text-subtitle-2 mt-2">3.3 CHoCH 结构转向</div><div class="text-caption text-medium-emphasis">反向突破确认后，当前结构段结束，新结构段开始。</div></v-col>
              ...
              <v-col cols="12" sm="6" md="3"><v-text-field :class="structureFieldClass('displacement_atr')" v-model.number="structureEngineConfig.displacement_atr" type="number" min="0.1" max="5" step="0.1" label="强位移阈值（ATR）" hint="达到后可跳过额外保持确认" persistent-hint density="compact" variant="outlined" /></v-col>
              <v-col cols="12"><div class="text-subtitle-2 mt-2">3.4 回踩确认</div><div class="text-caption text-medium-emphasis">突破后回到结构位附近，确认是否还能继续原方向。</div></v-col>
              ...
              <v-col cols="12"><div class="text-subtitle-2 mt-2">3.5 回收确认</div><div class="text-caption text-medium-emphasis">价格扫过结构位后重新收回，确认假突破或回撤结束。</div></v-col>
              ...
              <v-col cols="12"><div class="structure-zone-heading mt-2"><div class="text-subtitle-2">四、SETUP 执行 · 通用条件</div><div class="text-caption text-medium-emphasis">事件成立后，SETUP 还要满足这些入场、止损、止盈和确认条件才能执行。</div></div></v-col>
            ...
            <v-row class="mt-2">
              ...
              <v-col cols="12"><div class="structure-zone-heading mt-2"><div class="text-subtitle-2">四、SETUP 执行 · 计划生命周期</div><div class="text-caption text-medium-emphasis">结构事件失效、回踩失效和安全兜底共同决定计划何时停止等待。</div></div></v-col>
